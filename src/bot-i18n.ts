...
const translations: Record<BotLang, Record<string, string>> = {
  en: {
    ...
    'settings.voice_confirm.on': '🎤 Voice confirm: ON',
    'settings.voice_confirm.off': '🎤 Voice confirm: OFF',
  ...
  uk: {
    ...
    'settings.voice_confirm.on': '🎤 Підтв. голосу: УВІМК',
    'settings.voice_confirm.off': '🎤 Підтв. голосу: ВИМК',
