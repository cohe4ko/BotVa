...
const translations: Record<BotLang, Record<string, string>> = {
  en: {
    ...
    'tts.longPrompt': '🎙 Long text ({{chars}} chars). Which TTS engine? ElevenLabs = best quality, consumes credits.',
    'agent.full': 'FULL',
    'agent.ask': 'ASK USER',
    'agent.plan': 'PLAN',
  ...
  uk: {
    ...
    'tts.longPrompt': '🎙 Довгий текст ({{chars}} симв.). Який рушій TTS? ElevenLabs = найкраща якість, витрачає кредити.',
    'agent.full': 'ПОВНИЙ',
    'agent.ask': 'ЗАПИТ',
    'agent.plan': 'ПЛАН',
