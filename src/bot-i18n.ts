...
const translations: Record<BotLang, Record<string, string>> = {
  en: {
    ...
    'cb.stillQueued': '⏹ Stopped; {n} queued message(s) still to run',
    ...
    'progress.modelFallback': '🔀 <i>Model overloaded — continuing on {model}</i>',
    'progress.apiRetryOverloaded': '⏳ <i>API overloaded, retry {n}/{m}…</i>',
    'progress.apiRetryRateLimit': '⏳ <i>Rate limited, retry {n}/{m}…</i>',
    ...
    'progress.cute.modelFallback': '🔀 switching to a backup brain...',
    ...
    'settings.stt_lang': '🎙 STT: {label}',
    'settings.desc.stt_lang': 'Voice recognition language: fixes the language instead of auto-detect (Whisper often mistakes Ukrainian for Russian)',
    'stt.uk': 'Українська',
    'stt.ru': 'Російська',
    'stt.en': 'English',
    'stt.auto': 'Auto',
    'settings.think_lang': '💭 Think: {label}',
    'settings.desc.think_lang': "Language of the model's reasoning (thinking) and its summary. Auto = model decides (reasoning tends toward English); UA/EN steer it.",
    'think.uk': 'Ukrainian',
    'think.en': 'English',
    'think.auto': 'Auto',
    ...
    'settings.draft.on': '✍️ Streaming: ON',
    'settings.draft.off': '✍️ Streaming: OFF',
    'settings.desc.draft': 'Stream the draft reply while generating (may crash desktop Telegram)',
    'settings.protect_subagents.on': '🟢 🛡 Protect subagents',
    'settings.protect_subagents.off': '⚪ 🛡 Protect subagents',
    'settings.desc.protect_subagents': 'A follow-up message waits for running subagents instead of interrupting them (OFF = interrupt as before)',
    ...
    'tts.longPrompt': '🎙 Long text ({{chars}} chars). Which TTS engine? ElevenLabs = best quality (credits), Gemini = free & expressive.',
    'agent.full': 'FULL',
    'agent.ask': 'ASK USER',
    'agent.plan': 'PLAN',
  ...
  uk: {
    ...
    'cb.stillQueued': '⏹ Зупинено; у черзі лишилось {n} повідомл.',
    ...
    'progress.modelFallback': '🔀 <i>Модель перевантажена — продовжую на {model}</i>',
    'progress.apiRetryOverloaded': '⏳ <i>API перевантажений, повтор {n}/{m}…</i>',
    'progress.apiRetryRateLimit': '⏳ <i>Ліміт запитів, повтор {n}/{m}…</i>',
    ...
    'progress.cute.modelFallback': '🔀 перемикаюсь на запасний мозок...',
    ...
    'settings.stt_lang': '🎙 Голос: {label}',
    'settings.desc.stt_lang': 'Мова розпізнавання голосу: фіксує мову замість автовизначення (Whisper часто плутає українську з російською)',
    'stt.uk': 'Українська',
    'stt.ru': 'Російська',
    'stt.en': 'Англійська',
    'stt.auto': 'Авто',
    'settings.think_lang': '💭 Думки: {label}',
    'settings.desc.think_lang': 'Мова мислення (reasoning) і його резюме. Авто = модель сама (мислення тяжіє до англійської); UA/EN керують нею.',
    'think.uk': 'Українська',
    'think.en': 'Англійська',
    'think.auto': 'Авто',
    ...
    'settings.draft.on': '✍️ Стрімінг: ON',
    'settings.draft.off': '✍️ Стрімінг: OFF',
    'settings.desc.draft': 'Стрімити чернетку відповіді під час генерації (може крашити десктопний Telegram)',
    'settings.protect_subagents.on': '🟢 🛡 Захист субагентів',
    'settings.protect_subagents.off': '⚪ 🛡 Захист субагентів',
    'settings.desc.protect_subagents': 'Повідомлення вдогонку чекає завершення субагентів замість переривання (OFF = переривати, як раніше)',
    ...
    'tts.longPrompt': '🎙 Довгий текст ({{chars}} симв.). Який рушій TTS? ElevenLabs = найкраща якість (кредити), Gemini = безкоштовний і виразний.',
    'agent.full': 'ПОВНИЙ',
    'agent.ask': 'ЗАПИТ',
    'agent.plan': 'ПЛАН',
