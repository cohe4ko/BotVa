...
| `/undo` | Відкотити останній крок — наступне повідомлення продовжить з попередньої точки |
